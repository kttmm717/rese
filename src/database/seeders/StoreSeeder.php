    ...
    public function run()
    {
        $stores = [
            [
                ...
                'image_path' => 'public/img/sushi.jpg',
                'owner_id' => 1,
            ],
            [
                'name' => '牛助',
                ...
                'image_path' => 'public/img/yakiniku.jpg',
                'owner_id' => 2,
            ],
            [
                'name' => '戦慄',
                ...
                'image_path' => 'public/img/izakaya.jpg',
                'owner_id' => 3,
            ],
            [
                'name' => 'ルーク',
                ...
                'image_path' => 'public/img/italian.jpg',
                'owner_id' => 4,
            ],
            [
                'name' => '志摩屋',
                ...
                'image_path' => 'public/img/ramen.jpg',
                'owner_id' => 5,
            ],
            [
                'name' => '香',
